    ...
    <form onSubmit={handleSubmit} className="relative w-full">
      ...
      >
        ...
        <input
          ...
          className="w-full pl-12 pr-4 py-3 bg-transparent text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none rounded-lg font-medium"
        />
        {query && (
          <button
            type="button"
      ...
      {results.length > 0 && isFocused && (
        <div className="absolute top-full left-0 right-0 mt-2 bg-white dark:bg-slate-800 rounded-lg shadow-lg border border-gray-200 dark:border-slate-700 overflow-hidden z-50 animate-in">
          ...
          <Link
            ...
            onClick={onClose}
            className="flex items-center justify-center gap-2 p-3 text-sm font-semibold text-blue-700 dark:text-blue-400 hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors"
          >
